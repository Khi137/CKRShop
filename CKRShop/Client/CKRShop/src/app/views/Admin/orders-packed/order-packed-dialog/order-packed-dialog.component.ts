...
@Component({
  selector: 'app-order-packed-dialog',
  templateUrl: './order-packed-dialog.component.html',
  styleUrls: ['./order-packed-dialog.component.scss']
})
export class OrderPackedDialogComponent implements OnInit {
  code: any;
  id: any;
  user: any[] = [];
  product: any[] = [];
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialogRef: MatDialogRef<OrderPackedDialogComponent>,
