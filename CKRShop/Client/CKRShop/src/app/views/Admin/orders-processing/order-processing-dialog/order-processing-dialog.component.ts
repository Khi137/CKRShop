...
@Component({
  selector: 'app-order-processing-dialog',
  templateUrl: './order-processing-dialog.component.html',
  styleUrls: ['./order-processing-dialog.component.scss']
})
export class OrderProcessingDialogComponent implements OnInit {
  code: any;
  id: any;
  user: any[] = [];
  product: any[] = [];
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialogRef: MatDialogRef<OrderProcessingDialogComponent>,
