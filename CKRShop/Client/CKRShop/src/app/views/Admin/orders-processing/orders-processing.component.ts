...
@Component({
  ...
  templateUrl: './orders-processing.component.html',
  styleUrls: ['./orders-processing.component.scss']
})
export class OrdersProcessingComponent implements OnInit {
  ...
  openDialog() {
    this.dialog.open(OrderProcessingDialogComponent, {
      width: "30%",
      position: {
        top: '8%',
        left: '40%'
  ...
  getAllOrders() {
    //this.getAllUsers();
    this.api.getAllOrdersProcessing().subscribe({
      next: (res) => {
