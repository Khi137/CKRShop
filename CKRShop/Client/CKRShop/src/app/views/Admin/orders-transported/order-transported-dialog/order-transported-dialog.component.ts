...
@Component({
  selector: 'app-order-transported-dialog',
  templateUrl: './order-transported-dialog.component.html',
  styleUrls: ['./order-transported-dialog.component.scss']
})
export class OrderTransportedDialogComponent implements OnInit {
  code: any;
  id: any;
  user: any[] = [];
  product: any[] = [];
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialogRef: MatDialogRef<OrderTransportedDialogComponent>,
