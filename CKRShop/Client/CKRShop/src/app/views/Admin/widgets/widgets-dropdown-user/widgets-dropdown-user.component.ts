import { ApiService } from '../../../../Services-Admin/services-user-statistics/api.service';
import {
  AfterContentInit,
  AfterViewInit,
...
@Component({
  selector: 'app-widgets-dropdown-user',
  templateUrl: './widgets-dropdown-user.component.html',
  styleUrls: ['./widgets-dropdown-user.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class WidgetsDropdownUserComponent implements OnInit, AfterContentInit {
  numberUsers: number;
  numberActive: number;
  numberStaffs: number;
