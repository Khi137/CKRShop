...
@Component({
  selector: 'app-widgets-dropdown-order',
  templateUrl: './widgets-dropdown-order.component.html',
  styleUrls: ['./widgets-dropdown-order.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class WidgetsDropdownOrderComponent implements OnInit, AfterContentInit {
  numberOders: any;
  numberUserBuy: any;
  numberTotal: any;
