...
@Component({
  selector: 'app-widgets-dropdown-comment',
  templateUrl: './widgets-dropdown-comment.component.html',
  styleUrls: ['./widgets-dropdown-comment.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class WidgetsDropdownCommentComponent implements OnInit, AfterContentInit {
  numberComments: number;
  numberExisting: number;
  numberHidden: number;
  numberInactive: number;
  numberUserComment: number;
  constructor(
