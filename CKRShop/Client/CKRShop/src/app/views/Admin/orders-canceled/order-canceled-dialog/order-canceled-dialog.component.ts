...
@Component({
  ...
  templateUrl: './order-canceled-dialog.component.html',
  styleUrls: ['./order-canceled-dialog.component.scss']
})
export class OrderCanceledDialogComponent implements OnInit {
  code: any;
  id: any;
  user: any[] = [];
  product: any[] = [];
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialogRef: MatDialogRef<OrderCanceledDialogComponent>,
